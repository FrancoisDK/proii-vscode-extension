...
export class ComponentDefinitionProvider {
    private componentMap: Map<number, ComponentInfo> = new Map();
     ...
     */
    public extractComponents(document: vscode.TextDocument): void {
     ...
     */
    private extractComponentsFromLibidText(
        libidText: string, 
        startLine: number, 
     ...
     */
    public async showComponentDefinition(editor: vscode.TextEditor): Promise<void> {
     ...
     */
    private async displayComponentInfo(component: ComponentInfo, editor: vscode.TextEditor): Promise<void> {
     ...
     */
    private async showComponentInfoMessage(
        component: ComponentInfo,
        extraInfo: { type: string; formula: string; mw?: string } | null
    ): Promise<void> {
        ...
        vscode.window.showInformationMessage(
            `Component ${component.id}: ${component.name}${extraInfo ? ` (${extraInfo.formula})` : ''}`
        );
    }
     ...
     */
    private async goToDefinition(component: ComponentInfo, editor: vscode.TextEditor): Promise<void> {
     ...
     */
    private async showAllComponents(): Promise<void> {
