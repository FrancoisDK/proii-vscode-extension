# PRO/II Language Support v1.4.5 Release
...
- ✅ **Blue-only stream highlighting** - Only defined streams highlighted, no red for undefined
- ✅ **Accurate NAME section parsing** - Extracts only stream names, not descriptive text
- ✅ **Stream descriptions on hover** - Full descriptions from NAME section with formatting
- ✅ **STRM= context detection** - Works in all unit operation contexts
- ✅ **Professional documentation** - Cleaned up RIIG references
- ✅ **Semantic token support** - Modern VS Code highlighting API
- ✅ **Comprehensive keyword exclusions** - Prevents false positives
- ✅ **Parameter/unit operation highlighting** - TextMate grammar support
...
### Option 3: Download
Download `proii-language-support-1.4.5.vsix` from release assets
...
**Previous Versions:** [v1.4.4](https://github.com/FrancoisDK/proii-vscode-extension/releases/tag/v1.4.4) | [v1.4.3](https://github.com/FrancoisDK/proii-vscode-extension/releases/tag/v1.4.3)
